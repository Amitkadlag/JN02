...
public class LinkedHashMapDemo {
	...
	public static void main(String[] args) {
		// unordered, unsorted dictionary, null keys and values allowed
		//It is not thread safe
		  ...
		  HashMap<String, Float> ht1 = new HashMap<String, Float>();
		  ...
		  HashMap<Student,String> ht2=new HashMap<Student,String>(); ht2.put(new
